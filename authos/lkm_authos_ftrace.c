/*
 * This code is modified from https://github.com/ilammy/ftrace-hook.
 * The base framework did not suit my needs, so modifications were made to the library
...
#define pr_fmt(fmt) "lkm_authos: " fmt
